...
(FamilyTree._defaultConfig = function (e) {
			...
			(I.innerHTML = `<div>\n                        <div class="bft-edit-form-header" ${S}>\n                            ${A}\n                            <h1 class="bft-edit-form-title">${g}</h1>\n                            <div id="bft-avatar" class="bft-edit-form-avatar">${b}</div>                        \n                        </div>\n                        <div data-bft-edit-from-btns class="bft-edit-form-instruments">\n                        ${(function () {
				...
				for (var i in m) {
					...
					FamilyTree.isNEU(r) ||
						...
						(l && "Edit" == r.text) ||
						(e += `<div data-edit-from-btn='${i}' class="bft-img-button" ${S} title="${r.text}">${r.icon}</div>`);
				}
				return e;
			...
			(this.obj = e),
				...
				t.layout &&
					...
					(this.layouts.innerHTML =
						...
						'="normal" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#F3ADD7" x="7" y="41" width="50" height="27"></rect><rect fill="#F3ADD7" x="63" y="41" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="88" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="32" y1="35" y2="41" stroke-width="1"></line><line stroke="#000000" x1="88" x2="88" y1="35" y2="41" stroke-width="1"></line></svg><svg ' +
						FamilyTree.attr.layout +
						'="treeRightOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#F3ADD7" x="40" y="41" width="50" height="27"></rect><rect fill="#F3ADD7" x="40" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="35" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="35" x2="35" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="54" y2="54" stroke-width="1"></line></svg><svg ' +
						FamilyTree.attr.layout +
						'="treeLeftOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#F3ADD7" x="30" y="41" width="50" height="27"></rect><rect fill="#F3ADD7" x="30" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="85" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="85" x2="85" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="54" y2="54" stroke-width="1"></line></svg><svg ' +
						FamilyTree.attr.layout +
						'="mixed" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#F3ADD7" x="35" y="41" width="50" height="27"></rect><rect fill="#F3ADD7" x="35" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="41" stroke-width="1"></line><line stroke="#000000" x1="60" x2="60" y1="68" y2="73" stroke-width="1"></line></svg><svg ' +
						FamilyTree.attr.layout +
						'="tree" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#F3ADD7" x="7" y="41" width="50" height="27"></rect><rect fill="#F3ADD7" x="7" y="73" width="50" height="27"></rect><rect fill="#F3ADD7" x="63" y="41" width="50" height="27"></rect><rect fill="#F3ADD7" x="63" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="86" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="54" y2="54" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="86" y2="86" stroke-width="1"></line></svg>'),
	...
	(FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
		for (var s = i.nodes, d = [], c = 0; c < s.length; c++) {
			...
			(m = FamilyTree.STRING_TAGS
				...
				? p.tags.slice(0)
				: []),
				o.filterUI.addFilterTag(p) && m.push("filter");
	...
	(FamilyTree.manager._createNodes = function (e) {
				...
				if (m) {
					...
					if (!f) {
						if (!FamilyTree.isNEU(m.pid))
							(j = (T = o[m.pid]).childrenIds.indexOf(m.id)) > -1 &&
								T.childrenIds.splice(j, 1);
						s.push(m);
					}
				}
			}
		...
		for (c = 0; c < s.length; c++)
			FamilyTree.manager._iterate(s[c], s[c], o, 0, _, w, k, C, "", y, S, e);
			...
			if (
				...
				for (F = 0; F < g.subLevels; F++) {
					...
					if ((FamilyTree.manager._initDinamicNode(H, g.lcn), (T = g.parent)))
						(j = T.children.indexOf(g)) > -1 &&
							(T.children.splice(j, 1), T.children.splice(j, 0, H)),
							H.children.push(g),
							(H.parent = T),
							(g.parent = H),
							(o[H.id] = H);
					...
					: R.isPartner ||
					  (R.parent &&
							...
							(Object.defineProperty(
								C,
								H.id,
								Object.getOwnPropertyDescriptor(C, R.parent.id)
							),
							delete C[R.parent.id]),
					  (R.parent = H),
	...
	(FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
		for (
			var s = i.nodes, d = [], c = [], m = {}, p = {}, h = 0;
			h < s.length;
			h++
		) {
			var f,
				u = s[h];
			(f = FamilyTree.STRING_TAGS
				? u.tags
					? u.tags.split(",")
					: []
				...
				? u.tags.slice(0)
				: []),
				o.filterUI.addFilterTag(u) && f.push("filter"),
				u.gender && f.push(u.gender);
			...
			(g.ftChildrenIds = []),
				...
				null != i.orderBy &&
					(g.order = FamilyTree.manager._getOrderFieldValue(u, i.orderBy)),
				(e[u.id] = g),
				d.push(u.id),
				FamilyTree.isNEU(g.stpid)
					? (FamilyTree.isNEU(g.mid) ||
							(m[g.mid] || (m[g.mid] = []), m[g.mid].push(g.id)),
					  FamilyTree.isNEU(g.fid) ||
							(m[g.fid] || (m[g.fid] = []), m[g.fid].push(g.id)),
					  FamilyTree.isNEU(g.mid) &&
							FamilyTree.isNEU(g.fid) &&
							FamilyTree.isNEU(g.stpid) &&
							(c.has(g.id) || c.push(g.id)))
		...
		for (h = 0; h < c.length; h++) {
			...
			if (b) {
				var T = [];
				FamilyTree.manager._iterateSetRootIds(b.id, b.id, p, m, e, T),
					l.push(T);
			}
		}
	...
	(FamilyTree.templates.john.field_2 =
		"<text " +
		FamilyTree.attr.width +
		'="150" style="font-size: 13px;" fill="#aeaeae" x="60" y="170" text-anchor="middle" >{val}</text>'),
	...
	(FamilyTree.templates.tommy_female.node =
		'<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill="#F3ADD7" stroke="#aeaeae" rx="7" ry="7"></rect>'),
	...
	(FamilyTree.templates.mother.node =
		'<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;"  stroke-width="1" stroke="#F3ADD7" rx="5" ry="5"></rect><text style="font-size: 18px;" fill="#F3ADD7" x="240" y="30" text-anchor="end">Add mother</text>' +
		FamilyTree.icon.mother(70, 70, "#F3ADD7", 10, 40)),
	...
	(FamilyTree.templates.daughter.node =
		'<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#F3ADD7;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#F3ADD7" x="240" y="30" text-anchor="end">Add daughter</text>' +
		FamilyTree.icon.daughter(70, 70, "#F3ADD7", 10, 40)),
	...
	(FamilyTree.templates.wife.node =
		'<rect x="0" y="0" height="{h}" width="{w}" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#F3ADD7;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#F3ADD7" x="240" y="30" text-anchor="end">Add wife</text>' +
		FamilyTree.icon.wife(70, 70, "#F3ADD7", 10, 40)),
	(FamilyTree.templates.pet = Object.assign({}, FamilyTree.templates.mother)),
	(FamilyTree.templates.pet.node =
		'<rect x="0" y="0" style="fill:transparent;height:{h}; width:{w};stroke-width:1;stroke:#F3ADD7;rx:5;ry:5;"></rect><text style="font-size: 18px;" fill="#F3ADD7" x="240" y="30" text-anchor="end">Add pet</text>' +
		FamilyTree.icon.teddy(70, 70, "#F3ADD7", 10, 40)),
	...
	(FamilyTree.loading.show = function (e) {
		...
		(t.id = "bft-loading"),
			(t.innerHTML =
				'<style>@-webkit-keyframes dot-keyframes {0% { opacity: .4; -webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}@keyframes dot-keyframes {0% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}.bft-loading-dots div {margin: 10px;}      .bft-dot-1 {background-color: #039BE5;}.bft-dot-2 {background-color: #F3ADD7;}.bft-dot-3 {background-color: #FFCA28;}      .bft-loading-dots {text-align: center;width: 100%; position: absolute; top: 0;}.bft-loading-dots--dot {-webkit-animation: dot-keyframes 1.5s infinite ease-in-out;animation: dot-keyframes 1.5s infinite ease-in-out;        border-radius: 10px;display: inline-block;height: 10px;width: 10px;}.bft-loading-dots--dot:nth-child(2) {-webkit-animation-delay: .5s;animation-delay: .5s;}.bft-loading-dots--dot:nth-child(3) {-webkit-animation-delay: 1s;animation-delay: 1s;}</style><div class="bft-loading-dots"><div class="bft-loading-dots--dot bft-dot-1"></div><div class="bft-loading-dots--dot bft-dot-2"></div><div class="bft-loading-dots--dot bft-dot-3"></div></div>'),
	...
	(FamilyTree.clinkTemplates.orange = {
		defs: '<marker id="arrowOrange" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#F3ADD7" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotOrange" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#F3ADD7" /></marker>',
		link: '<path marker-start="url(#dotOrange)" marker-end="url(#arrowOrange)" stroke="#F3ADD7" stroke-width="2" fill="none" d="{d}" />',
		label:
			'<text fill="#F3ADD7" text-anchor="middle" x="{x}" y="{y}">{val}</text>',
	}),
					...
					if (
						(v.id == n.id
							...
							: FamilyTree._intersects(v, u, e.config) &&
							  ((u = FamilyTree._addPoint(v, s, e.config, u, c)), (T = !0)),
						v.id != n.id)
					) {
						for (; F; ) {
							if (F.id == n.id) {
							...
							FamilyTree._intersects(F, u, e.config) &&
								((u = FamilyTree._addPoint(F, s, e.config, u, c)), (T = !0)),
								(F = F.leftNeighbor);
						}
						for (; x; ) {
							if (x.id == n.id) {
							...
							FamilyTree._intersects(x, u, e.config) &&
								((u = FamilyTree._addPoint(x, s, e.config, u, c)), (T = !0)),
								(x = x.rightNeighbor);
						}
					}
					if (!T) {
						...
						if (v.parent)
							switch (
								((f = p.levelSeparation),
								(v.parent.layout != FamilyTree.mixed &&
									v.parent.layout != FamilyTree.tree) ||
									(f = p.mixedHierarchyNodesSeparation),
								p.orientation)
							) {
								case FamilyTree.orientation.top:
	...
	(FamilyTree.slinkTemplates.orange = {
		defs: '<marker id="arrowSlinkOrange" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#F3ADD7" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkOrange" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#F3ADD7" /></marker>',
		link: '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkOrange)" marker-end="url(#arrowSlinkOrange)" stroke-linejoin="round" stroke="#F3ADD7" stroke-width="2" fill="none" d="{d}" />',
		label:
			'<text dominant-baseline="middle" fill="#F3ADD7" alignment-baseline="middle" text-anchor="middle" x="{x}" y="{y}">{val}</text>',

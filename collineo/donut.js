//Pris sur https://github.com/finom/donutjs
...
(function (root, factory) {
	...
	var doc = document,
		...
		donut = function (options) {
			...
			if (IE) {
				...
				var fault =
						options.fault !== undefined ? options.fault : (weight / size) * 3, // fault is heuristic value of arc size deviation
					startAngle = -fault,
					arcStyle,
					fill;
	...
	if (IE) {
		...
		doc.createStyleSheet().cssText =
			'v\\:arc,v\\:fill{behavior:url(#default#VML);display:inline-block;position:absolute;}';
	}
	...
	//Ajouté au donut.js original
	donut.getColor = function (arc) {
		return arc.getAttribute('stroke');
	};
	//Fin des ajouts
